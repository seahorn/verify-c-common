...
As a prerequisite, follow [this guide](https://github.com/seahorn/seahorn/tree/dev14#developers-zone) to build SeaHorn locally.
...
As a prerequisite, build SMACK following [this guide](https://github.com/smackers/smack/blob/main/docs/installation.md). Note, we require to use [LLVM](http://llvm.org/) [14.0.6](https://releases.llvm.org/download.html#14.0.6). The last commit that SMACK supports LLVM 14 is [4894245](https://github.com/smackers/smack/commit/48942451a1f48e56442c70256f3f20d117f1b309).
...
As a prerequisite, build Symbiotic following [this guide](https://github.com/staticafi/symbiotic#building-symbiotic-from-sources). Note, we require to use [LLVM](http://llvm.org/) [14.0.6](https://releases.llvm.org/download.html#14.0.6).
...
As a prerequisite, build KLEE following [this guide](https://klee.github.io/build-llvm9/). Note, we require to use [LLVM](http://llvm.org/) [14.0.6](https://releases.llvm.org/download.html#14.0.6).
